...
// Event listeners
    ...
    numpad.addEventListener('click', (e) => {
        ...
        for (let specialKey in specialKeys) {
            if (pressedKey.textContent === specialKey) {
                
                specialKeys[specialKey];
                result.textContent += pressedKey.textContent;
                console.log(`${specialKey} was pressed.`);
            }
        }

        if (typeof parseInt(pressedKey.textContent) === 'number') {
            console.log('pressedKey is a number');
        }
